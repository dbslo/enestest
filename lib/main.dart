...
class _ExampleDragAndDropState extends State<ExampleDragAndDrop>
  ...
  Widget build(BuildContext context) {
    // lock the orientationa   .
    // dlo 2/4/22 works in myphone, and iossimilator.  no diffeencd in crhome and my ipa

    //   WidgetsFlutterBinding.ensureInitialized();  // dlo 2/4/22 not neeede to lcock screen
